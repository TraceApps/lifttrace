/**
 * Unit tests for server/lib/ssrf-guard.js, the shared SSRF guard
 * extracted from server/routes/radio-proxy.js so outgoing webhooks
 * (issue #79) don't carry a second, potentially-drifting copy of
 * security-critical logic. Pure functions plus one DNS lookup against
