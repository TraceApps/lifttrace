<script>
  ...
  const SECTION_KEYWORDS = {
    ...
    notifications:  ['notifications','reminders','workout reminder','rest day','streak','push','gotify','ntfy','apprise','celebration','pr','weekly summary','alert'],
    email:          ['email','smtp','mail','host','port','tls','password reset','invite'],
    users:          ['users','user management','accounts','login','admin','trainer','member','register','invite','session','my profile','account'],
