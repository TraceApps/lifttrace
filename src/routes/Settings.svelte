<script>
  ...
  const SECTION_KEYWORDS = {
    ...
    trace:          ['trace','ai','assistant','chat','provider','model','claude','openai','gemini','ollama','lm studio','deepseek','groq','localai','vllm','llama.cpp','mistral','base url','oai-compat','openai compatible','api key','rapidapi','artificial intelligence','bot','voice','hold to record','smart log','smart add','microphone','speech','attach','image'],
