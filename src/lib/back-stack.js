 ...
 * (back used to only know how to go back a page, so it left pages with a
 * sheet or dialog still open; NutriTrace #226). With nothing registered, back
 * goes back a page and then offers to exit, as before.
 *
