...
// the periodic PWA poll below). Anything else is the throttle between
// real GitHub API calls; a check attempted inside the window resolves
// from the cached blob instead of hitting the network.
