<!--
  ...
  All animations are pure CSS keyframes (no JS), so multiple instances on
  screen don't add up to JS work.

  Mirrors NutriTrace's TraceFace so the AI persona reads as the same
  character across both apps under the TraceApps brand.
-->
<script>
