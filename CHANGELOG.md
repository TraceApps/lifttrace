...
- **A cardio-only day now lights up the streak and week strip.** The Diary's "This Week" dots, streak counter, and calendar all read from workout history alone, so logging a run or a ride with no lifting that day left it looking like you'd done nothing. They now count either, for anyone who has cardio turned on, and the dot appears the moment you save the session rather than the next time you open the Diary.
