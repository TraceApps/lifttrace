...
- **MCP date-range reads.** Read workout sessions and body stats over inclusive arbitrary `start`/`end` date bounds, with history filters for recent workouts, records, and exercise progress; existing single-day tools remain unchanged.
