...
- **Trace AI coach.** Live workout context (active program, last 14 sessions, PRs, body weight), hold-to-record voice log, animated FFT visualizer. Supports Claude, OpenAI, Gemini, and any OpenAI-compatible endpoint. → [full guide](https://traceapps.github.io/docs/lifttrace/trace/)
